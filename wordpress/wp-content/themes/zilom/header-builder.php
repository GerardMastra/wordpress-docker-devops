...
*/ 
   $protocol = is_ssl() ? 'https' : 'http';
  	...
  	$header_position = get_post_meta($header_id, 'zilom_header_position', true);
?>
<!DOCTYPE html>
...
<body <?php body_class() ?>>
  	...
  	<div class="wrapper-page"> <!--page-->
	 	...
	 	<?php do_action( 'zilom_after_header' );  ?>
