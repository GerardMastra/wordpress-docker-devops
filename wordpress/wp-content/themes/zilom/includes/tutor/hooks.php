...
function zilom_course_settings_tabs($args){
   $args['general']['fields']['certificate'] = array(
      'type'         => 'text',
      'label'        => __('Certificate of Completion', 'zilom'),
      'default'      => __('Yes', 'zilom')
   );
   $args['general']['fields']['language'] = array(
      'type'         => 'text',
      'label'        => __('Language', 'zilom'),
      'default'      => __('English', 'zilom')
   );
